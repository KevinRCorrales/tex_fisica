...
%Revisar Calculos Teoricos del ejercicio 3 Margen de error muy alto, revisar si es mala interpretacion de los resultados o si es un error de calculo.
...
En este trabajo logramos analizar diferentes circuitos eléctricos utilizando métodos como 
la conversión estrella-triángulo, divisor de voltaje, divisor de corriente y las leyes de Kirchhoff. 
A través de los cálculos teóricos, las simulaciones y el montaje físico, se pudo comprender mejor 
cómo se comportan las corrientes y voltajes dentro de un circuito real.

Uno de los aspectos más importantes fue comprobar que los resultados teóricos sirven como una base 
muy confiable, ya que en la mayoría de los casos los valores obtenidos experimentalmente fueron 
bastante cercanos. Sin embargo, también se evidenció que siempre existen diferencias, las cuales 
se deben a factores como la tolerancia de las resistencias, pérdidas en las conexiones, errores 
de medición y variaciones en la fuente de alimentación.

Desde un punto de vista de aprendizaje, este trabajo permitió entender no solo cómo aplicar las 
fórmulas, sino también cuándo usarlas correctamente, por ejemplo, diferenciando entre divisor 
de voltaje y divisor de corriente según el tipo de circuito. Además, el uso de simuladores ayudó 
a validar los resultados antes de llevarlos al montaje físico.

En conclusión, la práctica permitió integrar teoría y experimentación, reforzando el análisis 
de circuitos eléctricos y demostrando que, aunque los modelos ideales son útiles, el comportamiento 
real siempre presenta pequeñas variaciones que deben tenerse en cuenta.
\end{document}
